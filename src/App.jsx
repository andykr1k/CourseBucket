  ...
  return (
    ...
    <form className='mx-10 md:mx-48 p-10'>   
      ...
      <div class="relative">
          ...
          <input type="search" id="default-search" class="block w-full p-4 pl-10 text-sm border rounded-lg bg-gray-700 border-gray-600 placeholder-gray-400 text-white focus:ring-blue-500 focus:border-blue-500" placeholder="Search by Name or Course ID" required onChange={(e) => setSearch(e.target.value)}></input>
    ...
    ?
      ...
      <div class="w-full h-32 p-6 bg-white border border-gray-200 rounded-lg shadow-md dark:bg-gray-800 dark:border-gray-700">
            <a href="#">
